        ...
        <div className='text-center'>
            <div className="mt-9 bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src='https://i.ibb.co/BL5vP3k/312841081-648522170217665-6350485512454630423-n-removebg-preview.jpg' className="sm:ml-0 lg:ml-40  max-w-sm rounded-lg shadow-2xl" />
                    <div>
